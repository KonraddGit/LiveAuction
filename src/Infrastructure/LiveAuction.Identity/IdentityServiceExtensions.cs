...
using LiveAuction.Identity.Services;
...
public static class IdentityServiceExtensions
{
        ...
        IConfiguration configuration)
    {
        ...
        services.AddDbContext<LiveAuctionIdentityDbContext>(options =>
            options.UseSqlServer(configuration.GetConnectionString(
                "LiveAuctionConnectionString"),
                b => b.MigrationsAssembly(typeof(
                    LiveAuctionIdentityDbContext).Assembly.FullName)));

        services.AddIdentity<ApplicationUser, IdentityRole>()
            .AddEntityFrameworkStores<LiveAuctionIdentityDbContext>()
